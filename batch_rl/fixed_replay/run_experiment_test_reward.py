...
class TestRunner(object):
  ...
  def take_action(self, state, rho_lim, re_cur, no):
      ...
      a_star, actions_cnt = self._vote_action(np.asarray(actions))
      self._logger.info(f'actions_cnt = {actions_cnt} at no = {no}')
      a_list = []
      ...
      for a in range(self.num_actions):
          ...
          if a == a_star:
            ...
            val_1 = actions_cnt[a_star]
            val_2 = actions_cnt[a] + (1 if a < a_star else 0)
            rho = (val_1 - val_2) // 2 + 1
